  ...
  return (
    <div className="pb-16">
      ...
      <div className="space-y-6 max-w-[72ch] text-sub text-pretty">
        <p>
          My coding journey began in 2020 when I stumbled across a few coding tutorials on YouTube out of curiosity. Since then, I've explored countless courses and different approaches to learning software development.
        </p>
        <p>
